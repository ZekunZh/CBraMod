...
class LoadDataset(object):
    ...
    def get_data_loader(self):
        ...
        train_set = CustomDataset(
            os.path.join(self.datasets_dir, "processed_train"), train_files
        )
        val_set = CustomDataset(
            os.path.join(self.datasets_dir, "processed_eval"), val_files
        )
        test_set = CustomDataset(
            os.path.join(self.datasets_dir, "processed_test"), test_files
        )
