...
def main():
    ...
    parser.add_argument(
        "--seed", type=int, default=3407, help="random seed (default: 0)"
    )
    parser.add_argument("--cuda", type=int, default=1, help="cuda number (default: 1)")
    parser.add_argument(
        "--epochs", type=int, default=50, help="number of epochs (default: 5)"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--weight_decay", type=float, default=5e-2, help="weight decay (default: 1e-2)"
    )
    parser.add_argument(
        "--optimizer", type=str, default="AdamW", help="optimizer (AdamW, SGD)"
    )
    ...
    parser.add_argument(
        "--num_of_classes", type=int, default=2, help="number of classes"
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default="/data/wjq/models_weights/Big/BigFaced",
        help="model_dir",
    )
    """############ Downstream dataset settings ############"""
    ...
    parser.add_argument(
        "--label_smoothing", type=float, default=0.1, help="label_smoothing"
    )
    parser.add_argument(
        "--multi_lr", type=bool, default=True, help="multi_lr"
    )  # set different learning rates for different modules
    parser.add_argument("--frozen", type=bool, default=False, help="frozen")
    parser.add_argument(
