...
db = lmdb.open(
    "/data/datasets/BigDownstream/Imagined speech/processed", map_size=3000000000
)
...
df = pd.read_excel(
    "/data/datasets/BigDownstream/Imagined speech/mat/Track3_Answer Sheet_Test.xlsx"
)
df_ = df.head(53)
