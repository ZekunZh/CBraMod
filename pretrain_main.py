...
def main():
    ...
    parser.add_argument(
        "--epochs", type=int, default=40, help="number of epochs (default: 5)"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--lr", type=float, default=5e-4, help="learning rate (default: 1e-3)"
    )
    ...
    parser.add_argument(
        "--dim_feedforward", type=int, default=800, help="dim_feedforward"
    )
    ...
    parser.add_argument(
        "--dataset_dir", type=str, default="dataset_dir", help="dataset_dir"
    )
